module Feedzirra  
  class Feed
    ...
    def self.feed_classes
      @feed_classes ||= [Feedzirra::Parser::IOSAppStoreRss, Feedzirra::Parser::RSSFeedBurner, Feedzirra::Parser::GoogleDocsAtom, Feedzirra::Parser::AtomFeedBurner, Feedzirra::Parser::Atom, Feedzirra::Parser::ITunesRSS, Feedzirra::Parser::RSS]
    end
